...
namespace Utility.Toolkit.Encodings
{
    ...
    /// Hex26 encoding.
    /// </summary>
    public static class Hex94
    {
        private const Int32 BASE_NUMBER = 94;
        ...
        /// <summary>
        /// Convert a number to a base 94 string. <br/>
        /// n > 0
        /// </summary>
        /// <param name="n"> </param>
        /// <returns></returns>
        public static String ToHex94(this Int64 n)
        {
            ...
            while (n > 0)
            {
                ...
                HEX_CACHE[start] = (char)(m + '!'); // 'A' is 65 in ASCII, so we add 64 to make 1 -> 'A', 2 -> 'B', ..., 26 -> 'Z'
        ...
        /// <summary>
        /// Parse a base 94 string to a number.
        /// </summary>
        ...
        /// <summary>
        /// Convert a number to a base 94 string.
        /// </summary>
        /// <param name="n"></param>
        /// <returns></returns>
        public static String ToHex94(this Int32 n)
        {
            return ToHex94((Int64)n);
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static String ToHex94(this UInt32 n)
        {
            return ToHex94((Int64)n);
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static String ToHex94(this Int16 n)
        {
            return ToHex94((Int64)n);
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static String ToHex94(this UInt16 n)
        {
            return ToHex94((Int64)n);
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static String ToHex94(this Byte n)
        {
            return ToHex94((Int64)n);
        }
    }
